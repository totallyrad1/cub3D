...
SRCS_B = bonus/get_next_line/get_next_line_bonus.c bonus/get_next_line/get_next_line_utils_bonus.c bonus/main_bonus.c bonus/minimap_bonus.c bonus/mlx_bonus.c bonus/parsing/fn_write_bonus.c bonus/parsing/ft_atoi_bonus.c bonus/parsing/ft_strncmp_bonus.c bonus/parsing/ft_substr_bonus.c bonus/parsing/parsing1_bonus.c bonus/parsing/parsing2_bonus.c bonus/parsing/parsing_bonus.c bonus/parsing/syntaxerror1_bonus.c bonus/parsing/syntaxerror_bonus.c bonus/ray_casting_bonus.c bonus/ray_casting_utils_bonus.c bonus/ray_generator.c bonus/sound_bonus.c bonus/textures.c bonus/render.c
